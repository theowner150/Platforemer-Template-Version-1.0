...
public class charscript : MonoBehaviour
{
    ...
    [Range(0, 1)] [SerializeField] public int speed = 3;
    ...
    public void Update()
    {
        ...
        if (Input.GetKey(KeyCode.S))
        {
            ...
            gameObject.GetComponent<Rigidbody2D>().AddForce(Vector2.down * 4);
        }

        if (Input.GetKeyDown(KeyCode.W) && IsGrounded == true)
        {
            gameObject.GetComponent<Rigidbody2D>().AddForce(new Vector3(0f, 10f, 0f), ForceMode2D.Impulse);
        }
